...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/MROTTTAMILOFFL/MR-X-SHEIK-WZML"><i class="fab fa-github"></i></a>
...
@app.route('/')
def homepage():
    return "<h1>See mirror-with-weeb <a href='https://github.com/MROTTTAMILOFFL/MR-X-SHEIK-WZML'>@GitHub</a> By <a href='https://t.me/MR_X_MIRROR'>Code With Weeb</a></h1>"
